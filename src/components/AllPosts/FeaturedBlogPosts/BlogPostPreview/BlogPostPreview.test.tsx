...
import BlogPostPreview from '@/components/AllPosts/FeaturedBlogPosts/BlogPostPreview';
import { BlogPostPreviewProps } from '@/components/AllPosts/FeaturedBlogPosts/BlogPostPreview/types';
